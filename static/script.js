window.onload=function(){
    ...
    function changeHomePage () {
        ...
        home_background.src="../static/img/banner/virus/background.png";
        stars.src="../static/img/banner/virus/stars.png";
        sun.src="../static/img/banner/virus/moon.png";
        logo_long.src="../static/img/banner/virus/logo-long.png";
    ...
    function addVirus() {
        ...
        var bugsListAdd = bugsList.innerHTML + '<div class="bug"><img src="../static/img/bug.png" alt=""></div>';
